...
exports.login = async (req, res) => {
    try {
        ...
        const loginReq = await axios.post("https://webservice.teamlocus.com/webservice_v44.svc/general_webuserlogin", params);
        // console.log("Response: ", loginReq);
        // const loginReq = await axios.post("http://192.168.75.131:91/WebService_v44.svc/general_webuserlogin", params);
