    ...
    try {
        ...
        if (userstatus == "start") {
            if (meeting && meeting.meeting_type == "nonperiodic") {
                ...
                return res.redirect(`https://betameet.teamlocus.com:8000/errorpage?${meeting.meeting_id}`);
            }
            ...
            if (meeting && meeting.meeting_type == "nonperiodic") {
                ...
                if (meeting.status == "started") {
                    ...
                    return res.redirect(`https://betameet.teamlocus.com:8000/${meeting.meeting_id}`)
                } else if (meeting.status == "ended") {
                    return res.redirect(`https://betameet.teamlocus.com:8000/end_meeting?${meeting.meeting_id}`)
                } else {
                    console.log("Else Meeting ID: ", meeting_id)
                    return res.redirect(`https://betameet.teamlocus.com:8000/waiting/${meeting_id}`);
                }
            }
            ...
            if (meeting && meeting.meeting_type == "periodic") {
                ...
                if (meeting.status == "started" 
                    ...
                    if (check) {
                        ...
                        return res.redirect(`https://betameet.teamlocus.com:8000/waiting/${meeting.meeting_id}`)
                    }
